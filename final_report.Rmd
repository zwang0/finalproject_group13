...
### Ridge
Ridge regression estimates coefficients of multiple linear regression 
with the aim for lower variance. By minimizing the shrinkage penalty, $\lambda \Sigma_{j=1}^k |\hat{\beta_j^2}|$, along with RSS, unnecessary estimated coefficients could be shrunk.

### LASSO
Lasso regression is a type of linear regression similar to Ridge, minizing shrinkage penalty $\lambda \Sigma_{j=1}^k |\hat{\beta_j}|$,  but performs selection in addition to shrinkage.
